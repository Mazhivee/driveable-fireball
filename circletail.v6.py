...
for _ in range(num_sterretjes):
    ...
    ster_positie = [random.randint(-10, 10), random.randint(-10, 10)]
    ster_levensduur = random.randint(20, 100)
    ster_verdwijn_timer = ster_levensduur

    sterretjes.append([ster_grootte, ster_positie, ster_levensduur, ster_verdwijn_timer])
...
while running:
    ...
    # Bewaar de positie van de sterretjes
    for ster in sterretjes:
        ster[3] -= 1
        if ster[3] <= 0:
            ster[1] = [random.randint(-10, 10), random.randint(-10, 10)]
            ster[3] = ster[2]
    ...
    for ster in sterretjes:
        pygame.draw.circle(screen, white, [stip_positie[0] + ster[1][0], stip_positie[1] + ster[1][1]], ster[0])
